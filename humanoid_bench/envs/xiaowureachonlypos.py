    ...
    def get_reward(self):
        ...
        def calculate_part_reward(pos_err, vel, part_name):
            ...
            return {
                ...
                f"{part_name}_reached3": vel <= 0.05,
                f"{part_name}_reached5": pos_err <= 0.05 and vel <= 0.05
            }
            
            
        # 计算各部位奖励
        elbow_l_reward = calculate_part_reward(elbow_l_pos_err, wrist_l_vel, "elbow_l")
        elbow_r_reward = calculate_part_reward(elbow_r_pos_err, wrist_r_vel, "elbow_r")
