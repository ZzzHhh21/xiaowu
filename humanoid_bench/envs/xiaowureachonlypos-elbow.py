    ...
    def get_reward(self):
        ...
        def calculate_part_reward(pos_err, vel, part_name):
            ...
            return {
                ...
                f"{part_name}_reached5": pos_err <= 0.05 and vel <= 0.1
            }
        ...
        left_success_bonus = 3 if self._left_reached5 else 0.0
        right_success_bonus = 3 if self._right_reached5 else 0.0
